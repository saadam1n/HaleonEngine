...
namespace Haleon {
	...
	void CoreRenderer::Create(GraphicsWindow* Window) {
		...
		DeviceCreateFlags |= D3D10_CREATE_DEVICE_SINGLETHREADED;
#ifdef HALEON_DEBUG
		DeviceCreateFlags |= D3D10_CREATE_DEVICE_DEBUG;
#endif
		D3D10CreateDevice(Adapter, D3D10_DRIVER_TYPE_HARDWARE, NULL, DeviceCreateFlags, D3D10_SDK_VERSION, &Device);
